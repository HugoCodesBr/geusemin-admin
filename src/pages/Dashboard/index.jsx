    ...
    <div className="container">
      <div className='dashboard'>
        <div className="dashboard__accordion" >
          <div className="dashboard__head" onClick={() => setAccordion(!accordion)}>
            <h3>Hoje</h3>
            {accordion ? (
              <BiChevronUp size={20} color="#00000066"/>
            ) : (
              <BiChevronDown size={20} color="#00000066"/>
            )}
          </div>
          <div className={`dashboard__content ${accordion ? "active" : ""}`}>
