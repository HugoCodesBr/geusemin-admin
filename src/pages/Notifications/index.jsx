...
const Notifications = () => {
    ...
    const handleRemoveNotification = (e, removeItem) => {
        e.preventDefault()
        setNotifications((prevNotifications) => prevNotifications.filter((item) => item !== removeItem))
    }
        ...
        <div className="container">
            <div className='notifications'>
                <div className="notifications__head">
                    <h2>Notificações</h2>
                    <button className='button-outline' onClick={(e) => handleClearAll(e)}>Limpar notificações</button>
                </div>
                    ...
                    {itemsToShow.map((notification, index) => (
                        <div key={index} className="notification">
                            ...
                            <div className="notification__buttons">
                                <button className="button-outline" onClick={(e) => handleRemoveNotification(e, notification)}>Limpar</button>
                ...
                <div className="pagination">
                    ...
                    {Array.from({ length: Math.ceil(notifications.length / itemsPerPage) }, (_, index) => (
                        <button key={index} className={`pagination__page ${currentPage === index + 1 ? "active" : ""}`} onClick={() => changePage(index + 1)}>
                            {index + 1}
                        </button>
                    ))}
