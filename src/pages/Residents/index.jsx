...
import { HiOutlineDesktopComputer, HiOutlinePhone, HiOutlineDotsVertical, HiOutlineUserGroup } from 'react-icons/hi'
          ...
          <div className="modal">
            ...
            <div className="modal__content">
              <div className="modal__title">
                <HiOutlineUserGroup size={50} color='#000'/>
              ...
              <div className="modal__form">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="modal__row grid-1-4-2">
                    ...
                    <div className="modal__field">
                      <label htmlFor="name">Nome Morador</label>
                      <input
                        type="text"
                        name="name"
                        id="name"
