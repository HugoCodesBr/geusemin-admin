              ...
              <div className="modal__form">
                <form onSubmit={handleSubmit}>
                  <div className="modal__row grid-4-1">
                    ...
                    <div className="modal__field">
                      <label htmlFor="process">Nº de processo</label>
                      <input
                        type="text"
                        name="process"
                        id="process"
                  ...
                  <div className="modal__row grid-1-3">
                    <div className="modal__field">
                      <label htmlFor="date">Data da distruibuição</label>
                      <input
                        type="text"
                        name="date"
                        id="date"
                  ...
                  <div className="modal__row grid-1-3">
                    <div className="modal__field">
                      <label htmlFor="values">Valor da causa</label>
                      <input
                        type="text"
                        name="values"
                        id="values"
